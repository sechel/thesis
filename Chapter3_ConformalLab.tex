...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{conformllab/conformal_data_light.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.48\linewidth]{conformllab/main_interface_light2.pdf}\hfill
\begin{minipage}[b]{0.5\linewidth}
\includegraphics[width=0.96\linewidth]{conformllab/hyperelliptic_curve_light.pdf}
\vspace{1mm}\\
\includegraphics[width=0.96\linewidth]{conformllab/schottky_modeller_light.pdf}
\end{minipage}
...
\begin{figure}
\resizebox{\textwidth}{!}{
\includegraphics[width=0.7\linewidth]{conformllab/visualization_light.pdf}
}
