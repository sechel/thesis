...
\centering
\includegraphics[width=0.9\linewidth]{conformllab/conformal_data.png}
...
\begin{wrapfigure}{R}{0.45\textwidth}
\centering
\includegraphics[width=0.9\linewidth]{conformllab/hyperelliptic_curve.png}
...
a metric calculated from the Schottky data, see~\ref{sec:}. Similar to the 
generation of hyperelliptic data additional points can be added and modified my
a regularization process. In addition to this the number of points that discretize the
circles can be given.

\begin{wrapfigure}{R}{0.45\textwidth}
\centering
\includegraphics[width=0.9\linewidth]{conformllab/schottky_modeller.png}
...
\begin{wrapfigure}{R}{0.45\textwidth}
\centering
\includegraphics[width=0.9\linewidth]{conformllab/main_interface.png}
