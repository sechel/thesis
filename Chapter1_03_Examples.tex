...
the polygonal branched tetrahedron as its structure is flat by definition see Figure~\ref{fig:wente_uniform}.
...
\begin{figure}
	...
	\caption{Uniformization of a discrete wente torus. Points on the sphere are chosen to form a regular subdivision
of the elliptic lattice. Red points are branch points of the surface.}
	\label{fig:wente_uniform}
\end{figure}

\begin{figure}
	\centering
	\includegraphics[height=5cm]{elliptic_square_uniform/square_uniform_fine_image.pdf}
	\includegraphics[height=5cm]{elliptic_square_uniform/square_uniform_fine_domain.pdf}
	\caption{Uniformization of a square surface. Points on the sphere are chosen to form a regular subdivision
of the elliptic lattice. Red points are branch points of the surface. Red edges represent the boundary of the 
fundamental domain.}
	\label{fig:wente_uniform}
\end{figure}	
...
\begin{figure}[p]
	...
	\caption{Discrete Weierstrass $\wp$ functions with randomized data. Regular tetrahedron $\tau=\sin(\frac{\pi}{3})i$ (top), Square $\tau=i$ (middle), generic position branch points $\tau \approx 0.18+i\cdot 0.67$.}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.45\linewidth]{data/schottky_g2/genus2_image}
	\includegraphics[width=0.45\linewidth]{data/schottky_g2/genus2_domain}
