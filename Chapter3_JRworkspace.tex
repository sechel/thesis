...
within DDG. It is currently beeing used for teaching mathematical visualization courses at 
...
similar to the DDG Framework. Section~\ref{chp:jrworkspace} introduces the {\sc JRworkspace} library of the 
...
tool~\cite{JrealityWebsite}. Section~\ref{chp:halfedge} introduces the 
...
In Section~\ref{chp:conformallab} we describe the software 
