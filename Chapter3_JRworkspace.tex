...
undergraduate students with a visualization emphasis~\cite{VisMathHomepage, 
...
specifically designed for the creation of custom interactive software for experiments with algorithms and geometries treated within DDG. It is currently being used for teaching mathematical visualization courses at TU-Berlin \cite{VisMathHomepage} and for research projects within the geometry group.
...
publications~\cite{Bobenko2010, OWR2012, Sechelmann2012}.
