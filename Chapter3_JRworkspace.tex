...
this class is used as a namespace to avoid property name ambiguities. The value of {\tt doubleState}
...
{\tt getPlugin}, which returns the unique instance of the given plug-in class. The semantics
...
deserialization may fail if the class geometry changes. 
	},
...
shown in a user interface, as well as the {\tt vendorName} and {\tt email} information. An optional 
...
%In the next section we describe a reference implementation of this API.
