...
%\begin{figure}
%  \centering
%  \includegraphics[width=\textwidth]{images/flowchart_bpmn_horizontal.pdf}
%  \caption{Overview of the algorithmic steps described in this paper.}
%  \label{fig:flowchart}
%\end{figure}
...
%\begin{itemize}
%\item Explain structure of article
%  \begin{itemize}
%  \item Parametrization
%  \item Periodic discrete Conformal parametrization, why is it
%    important to have a conformal periodic parametrization?
%  \item Architectural tiling
%  \item Rationalization
%  \end{itemize}
%\item cite related work
%\end{itemize}
