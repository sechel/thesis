...
implementation. For a complete reference see the documentation on the {\sc Jtem} website 
\cite{JtemWebsite}.
...
\begin{figure}[H]
\centering
\includegraphics[width=9cm]{jrworkspace/menu_aggregator_03.png}
...
This plug-in flavor creates a {\sc Java Swing\TReg} tool bar at the top of the main window. There
can be more than one plug-in implementing this interface to create multiple tool bars.

\begin{figure}[H]
\centering
\includegraphics[width=9cm]{jrworkspace/tool_bar_aggregator.png}
