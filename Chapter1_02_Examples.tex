...
\begin{definition}
Let $v_1,\ldots, v_n \in V\subset\S^2$. A triangulation of the convex hull of $v_1,\ldots, v_n$ is called a
\emph{discrete Riemann sphere}. We denote $\Chat_V$ as the discrete Riemann sphere with vertex set 
$V$.
\end{definition}
...
\begin{definition}
Let $S$ be a discrete surface without boundary and vertices $v_1,\ldots,\v_n\in\S^2$. $S$ is a \emph{discrete double
branched cover if there exist $i_1,\ldots,\i_{2g+2}\in
