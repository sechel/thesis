...
The notion of discrete conformal equivalence of triangle meshes was introduced in \cite{Springborn2008} and extended to hyperbolic metrics in \cite{BPS2015:dconf}. 
...
We generalize the variational principles established in \cite{BPS2015:dconf} and present a wealth of constructions and examples. 
...
Diskrete konforme \"{A}quivalenz von Dreiecksnetzen wurde in \cite{Springborn2008} behandelt und in \cite{BPS2015:dconf} auf hyperbolische Metriken erweitert.
