%!TEX root = ./Thesis.tex
\chapter{Variational Methods for Discrete Surface Parameterization}
\chaptermark{Variational Methods}

\section{Discrete quasiisothermic parametrizations}

This work is joint woth with Thilo R{\"o}rig and Alexander Bobenko and was published in 
\cite{Sechelmann2012}
...
\centering
\resizebox{\textwidth}{!}{
\includegraphics[width=0.48\linewidth]{image/aag2012/cover01.png}
\includegraphics[width=0.48\linewidth]{image/aag2012/cover02.png}
}\\
\resizebox{\textwidth}{!}{
\includegraphics[width=0.48\linewidth]{image/aag2012/cover03.png}
\includegraphics[width=0.48\linewidth]{image/aag2012/cover04.png}
}
...
energy recently described by \cite{Schiftner2009}. They construct circle
...
\subsection{Discrete quasiisothermic parameterization}
...
\subsection{Minimization of the Functional}
\label{sec:algorithm}
...
\subsection{Discrete S-isothermic surfaces}
\label{sec:s-isothermic}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{image/aag2012/all_circles.png}
...
\begin{figure}
\centering
\resizebox{\textwidth}{!}{\includegraphics[width=\textwidth]{image/aag2012/dach_example01_circles.png}}
...
\subsection{A discrete S-isothermic ellipsoid and its dual surface}

\begin{figure*}
\centering
\resizebox{\textwidth}{!}{
$\vcenter{\hbox{\includegraphics[width=0.5\textwidth]{image/ellipsoid01_top.png}}}$
$\vcenter{\hbox{\includegraphics[width=0.5\textwidth]{image/ellipsoid01_disks.png}}}$
}
...
\includegraphics[width=0.5\textwidth]{image/ellipsoid01_dual.png}
\includegraphics[width=0.5\textwidth]{image/ellipsoid01_dual_disks.png}
}
