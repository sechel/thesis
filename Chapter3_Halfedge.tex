...
over incoming edges at a vertex, or iterating over the boundary edges of a surface or a face, and many 
more.
...
\lstinputlisting[
	caption={Algorithm that uses data from the {\tt AdapterSet}. The {\tt get} method of the
		...
		matching adapter is found (Line~13). It uses {\tt @FunctionValue} and {\tt @Weight} annotated 
