...
\begin{figure}
    \begin{center}
    \includegraphics[width=\textwidth]{varylab/tools_light.pdf}
...
\begin{figure}
    \begin{center}
    \includegraphics[width=\textwidth]{varylab/visualization_light.pdf}\\
    \vspace{1mm}
    \includegraphics[width=\textwidth]{varylab/visualization_histo_light.pdf}    
...
\begin{center}
    \resizebox{\linewidth}{!}{
        \includegraphics[width=\textwidth]{varylab/optimization_plugins_light.pdf}
        \includegraphics[width=\linewidth]{varylab/optimization_light.pdf}
    }
...
\begin{figure}
\begin{center}
\includegraphics[width=\textwidth]{varylab/protocol_light.pdf}
...
\begin{minipage}{\linewidth}
            ...
            \resizebox{\linewidth}{!}{
                \includegraphics[width=3.2cm]{periodic/step01_ui_light.pdf}
...
\begin{minipage}{0.8\linewidth}
            \centering
            \includegraphics[width=0.7\linewidth]{periodic/step03_quads.pdf}
            \includegraphics[width=0.7\linewidth]{periodic/step03_triangles.pdf}		
            \captionof{figure}{Pattern preview using the \emph{Content Appearance$\to$Texture} user interface.}
\end{minipage}
\begin{minipage}{0.19\linewidth}
         	\includegraphics[width=4cm]{periodic/step03_ui_light.pdf}
\end{minipage}
\end{center}    
...
\includegraphics[width=4.5cm]{periodic/step04_ui_light.pdf}	
\end{minipage}
\end{center}    
...
\includegraphics[width=4.5cm]{periodic/step09_fconst_light.pdf}
\end{minipage}
\end{center}
...
\end{minipage}
\begin{minipage}{0.29\linewidth}
\includegraphics[width=4.5cm]{periodic/step10_springs_light.pdf}
\end{minipage}
\end{center}            
\end{compactenum}
...
\includegraphics[width=\linewidth]{quasiisothermic/step02_ui_light.pdf}
\end{minipage}
\end{center}     
...
\begin{minipage}{0.75\linewidth}
            ...
            \captionof{figure}{Three-step remeshing of the parameterized surface. Create a subdivided domain (left), lift this mesh to the surface (middle). Extract the new mesh from the subdivided (right).}
            \label{fig:three-step-remeshing}
\end{minipage}
\hfill
\begin{minipage}{0.24\linewidth}
\includegraphics[width=5cm]{quasiisothermic/step06_ui_light.pdf}
\end{minipage}
\end{center}                 
...
\begin{minipage}{\linewidth}
            ...
            \includegraphics[width=9cm]{gridshells/step5_hist.pdf}   
            \captionof{figure}{Reference surface visualization (left). Optimized mesh (right). Optimized histogram (bottom).}
\end{minipage}
\end{center}   
