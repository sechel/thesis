...
\begin{minipage}{0.19\linewidth}
         	\includegraphics[width=4cm]{periodic/step03_ui.pdf}
\end{minipage}
\end{center}    
...
\includegraphics[width=4.5cm]{periodic/step04_ui.pdf}	
\end{minipage}
\end{center}    
...
\includegraphics[width=4.5cm]{periodic/step09_fconst.pdf}
\end{minipage}
\end{center}
...
\end{minipage}
\begin{minipage}{0.29\linewidth}
\includegraphics[width=4.5cm]{periodic/step10_springs.pdf}
\end{minipage}
\end{center}            
\end{compactenum}
...
\end{minipage}
\begin{minipage}{0.24\linewidth}
\includegraphics[width=5cm]{quasiisothermic/step06_ui.pdf}
\end{minipage}
\end{center}                 
