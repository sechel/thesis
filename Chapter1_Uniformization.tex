...
%\sidecaption%[t]
\centering
\makebox[0pt][r]{\includegraphics[width=0.4\textwidth]{notation_triangle_circle.pdf}}%
%\hspace*{0.3\textwidth}
...
\begin{figure}
  %\sidecaption
  \centering
  \includegraphics[width=0.4\linewidth]{lobachevskyplot}
...
\begin{theorem}[Necessary condition for the existence of conformal map]
...
\begin{figure}
	\includegraphics[height=0.34\textwidth]{planar_streams/triangle_cylinder.pdf}
	\hfill
	\includegraphics[height=0.34\textwidth]{planar_streams/triangle_cylinder_image.pdf}
        \hfill	
	\includegraphics[height=0.34\textwidth]{planar_streams/triangle_cylinder_domain.pdf}\\
	\includegraphics[height=0.34\textwidth]{planar_streams/arrow_cylinder.pdf}
	\hskip 0.01\textwidth
	\includegraphics[height=0.34\textwidth]{planar_streams/arrow_cylinder_image.pdf}\hfill
	\hskip 0.01\textwidth
	\includegraphics[height=0.34\textwidth]{planar_streams/arrow_cylinder_domain.pdf}\\
	\includegraphics[width=0.5\textwidth]{planar_streams/circular_stream_03_lines.pdf}
	\includegraphics[width=0.5\textwidth]{planar_streams/circular_stream_03_mesh.pdf}
...
\begin{figure}
\centering%
\includegraphics[width=0.3\textwidth]{spherical_cyclic/cube_cyclic_domain.pdf}%
\hspace{0.1\textwidth}%
\includegraphics[width=0.3\textwidth]{spherical_cyclic/cube_cyclic_image.pdf}%
...
\begin{figure}
\centering
\hspace*{\fill}\includegraphics[height=0.4\textwidth]{genus3/genus3.pdf}\hfill%
\includegraphics[height=0.4\textwidth]{genus3/canonical_mesh.pdf}\hspace*{\fill}
...
\begin{figure}
\centering
\hspace*{\fill}\includegraphics[height=0.35\textwidth]{genus5/genus5.pdf}\hspace*{\fill}%
\includegraphics[height=0.35\textwidth]{genus5/fundamental.pdf}\hspace*{\fill}
...
\begin{figure}
\centering
(a)\includegraphics[height=0.45\textwidth]{algorithm/step1_boundary.pdf}
(b)\includegraphics[height=0.45\textwidth]{algorithm/step2.pdf}
\\
(c)\includegraphics[height=0.45\textwidth]{algorithm/step3.pdf}
(d)\includegraphics[height=0.45\textwidth]{algorithm/contract_combined.pdf}
\\
(e)\includegraphics[height=0.45\textwidth]{algorithm/step5.pdf}
(f)\includegraphics[height=0.45\textwidth]{algorithm/step5_5.pdf}
...
% \input{figure/algorithm/cutCanonical.pdf_t}
% }
...
% \input{figure/algorithm/moveElement.pdf_t}
% }
...
\begin{figure} 
\centering
\includegraphics[width=0.6\textwidth]{branched_genus_2/mercator_texture.pdf}\\
\includegraphics[height=0.25\textwidth]{branched_genus_2/image_stereographic_all_real.pdf}%
\quad%
\includegraphics[height=0.25\textwidth]{branched_genus_2/image_stereographic_all_real_closeup.pdf}
...
% For the canonical fundamental domain we pick $0$ to be the vertex of the domain and proceed as described in Section~\ref{sec:polygons_generators}.
...
% as described in Section~\ref{sec:hyperelliptic_domain}. The rotational
% symmetry of the surface corresponds to the hyperelliptic involution of
% the surface. Its fix points, i.e. the intersection of the axis of
% symmetry with the surface, correspond to the branch points of the
% hyperelliptic curve. Thus the vertex of the fundamental polygon has to
% be a point on the symmetry axis of the surface. We choose one of the
% six points and proceed as explained in
% Section~\ref{sec:polygons_generators} for oppositely identified
% polygons. As the system of loops forming the boundary of the polygon
