...
Section~\ref{sec:tori:schottky} introduces the discrete uniformization of tori given by Schottky data, i.e., a group of loxodromic transformations together with a set of circles in $\Chat$. 
...
Corresponding edges in $\Chat$ have the same length-cross-ratio as this characterization is invariant under M\"{o}bius traformations.
