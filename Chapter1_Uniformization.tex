...
\begin{definition}
Let $l_{\it ij}:E\to R_{>0}$ be the edge lengths of the $\tilde \Sigma$. Define
\begin{eqnarray*}
...
\begin{eqnarray}
d^2E^{\rm euc}(u)&=&\frac{1}{2}\sum_{\it ij \in \bar E} \cot \alpha_k \cdot (du_i - du_j)^2.
\end{eqnarray}
...
&=&\frac{1}{2}\sum_{\it ij \in \bar E} \cot \alpha_k \cdot (d\tilde\lambda_{\it ki}-d\tilde\lambda_{\it jk})^2.
\end{eqnarray*}
and
\begin{eqnarray*}
d^2E^{\rm euc}(\lambda, u)&=&\frac{1}{2}\sum_{\it ij \in \bar E} \cot \alpha_k \cdot (d\lambda_{\it ki}-d\lambda_{\it jk} + du_i - du_j)^2.
\end{eqnarray*}
...
\todo{explain why this leads to cyclic hyperbolic polygons}
...
\resizebox{\textwidth}{!}{
\raisebox{0.75cm}{
\includegraphics[height=3.5cm, draft = false]{circle_domain_hyperbolic/brezel_three_holes_edges.pdf}
}
\includegraphics[height=5cm, draft = false]{circle_domain_hyperbolic/brezel_three_holes_domain.pdf}
}
