...
\includegraphics[width=0.25\linewidth]{introduction/genus0_image.pdf}
\quad
\includegraphics[width=0.25\linewidth]{introduction/genus0_domain.pdf}
 }
\resizebox{0.8\linewidth}{!}{
\includegraphics[width=0.25\linewidth]{introduction/genus1_image.pdf}
\quad    
\includegraphics[width=0.25\linewidth]{introduction/genus1_domain.pdf}
}
\resizebox{0.8\linewidth}{!}{
\includegraphics[width=0.25\linewidth]{introduction/genus3_image.pdf}    
\quad   
...
The fundamental domain of the parameterization if a (canonical) hyperbolic polygon. 
...
\todo{Reference to the ConformalLab section and the description of the XML data format.}
...
\begin{figure}
\centering
\includegraphics[width=0.3\textwidth, draft=false]{notation_triangle.pdf}
...
the minimizer realizes this pattern in addition to being cyclic. \todo{Why?}
...
\item
Solve Problem~\ref{prob:factors_and_angles} for $\Sigma'$ with prescribed $\Theta_i=2\pi$ for interior vertices in $\Sigma'$, $\Theta_i=\pi$ for boundary vertices in $\Sigma'$ that are not neighbors of $k$ in $\Sigma$. 
...
\todo{We do not have length cross ratios. What is the argument without $\lcr$?}
...
\centering
\resizebox{\textwidth}{!}{
\includegraphics[width=0.5\textwidth, draft = false]{circle_domain_euclidean/three_holes_image.pdf}
\includegraphics[width=0.5\textwidth, draft = false]{circle_domain_euclidean/three_holes_domain.pdf}
\includegraphics[width=0.5\textwidth, draft = false]{circle_domain_euclidean/three_holes_map.pdf}
}
...
In the smooth setting all topological spheres are conformally equivalent.
See also Figure~\ref{fig:intro_uniformization}, left.
...
\includegraphics[height=5cm]{spherical_cyclic/cube_cyclic_image.pdf}
}
\setstretch{0.0}{\scriptsize\tt data/spherical\_cyclic/spherical\_circular.xml}
\caption{Spherical cyclic conformal map.}
\label{fig:spherical_circular}
\end{figure}


Mapping a discrete cyclic surface with spherical topology to discretely conformally the round sphere amount to a similar procedure as described in Section~\ref{sec:riemann_map}.
...
\label{sec:tori}
See also Figure~\ref{fig:intro_uniformization}, middle.
...
\setstretch{0.8}{\scriptsize\tt data/wente\_uniform/wente\_uniform\_branched.xml}
\caption{
...
\subsubsection{Regular triangulations on the sphere}
