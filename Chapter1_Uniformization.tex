...
The images in Figure~\ref{fig:roots_of_unity_curve} suggest that we can find special fundamental domains for hyperelliptic surfaces. 
...
\todo{complete proof or leave it a conjecture.}
\end{proof}
