...
Figure~\ref{fig:schottky_g3} shows a examples of the Fuchsian
...
\resizebox{\textwidth}{!}{
\includegraphics[height=0.5\textwidth]{branched_genus_2/image_stereographic_all_real.pdf}%
\quad%
\includegraphics[height=0.5\textwidth]{branched_genus_2/image_stereographic_all_real_closeup.pdf}
}
