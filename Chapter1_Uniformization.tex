...
In Section~\ref{sec:hyperelliptic} we treat the special class of hyperelliptic surfaces, i.e., surfaces that are conformally equivalent to a 2-sheeted branched cover of~$\Chat$.
