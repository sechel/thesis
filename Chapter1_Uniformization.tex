...
\setstretch{0.8}{\scriptsize\tt data/wente\_uniform/wente\_uniform.xml}
\caption{Uniformization of a discrete wente torus $\mu^2=\lambda(\lambda^3-1)$. Points on the sphere are
...
\setstretch{0.8}{\scriptsize\tt data/elliptic\_square\_uniform/square\_uniform\_fine.xml}
